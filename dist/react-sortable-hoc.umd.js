	...
	function sortableContainer(WrappedComponent) {
	  ...
	  return _temp = _class = function (_React$Component) {
	    ...
	    function WithSortableContainer(props) {
	      ...
	      defineProperty(assertThisInitialized(_this), "handleStart", function (event) {
	      ...
	      defineProperty(assertThisInitialized(_this), "nodeIsChild", function (node) {
	        return node.sortableInfo.manager === _this.manager;
	      });

	      defineProperty(assertThisInitialized(_this), "handleMove", function (event) {
	      ...
	      defineProperty(assertThisInitialized(_this), "handlePress", function (event) {
	        try {
	      ...
	      defineProperty(assertThisInitialized(_this), "handleSortMove", function (event) {
	      ...
	      defineProperty(assertThisInitialized(_this), "handleSortEnd", function (event) {
	      ...
	      defineProperty(assertThisInitialized(_this), "autoscroll", function () {
	      ...
	      defineProperty(assertThisInitialized(_this), "onAutoScroll", function (offset) {
	      ...
	      defineProperty(assertThisInitialized(_this), "keyLift", function (event) {
	      ...
	      defineProperty(assertThisInitialized(_this), "keyMove", function (shift) {
	        var nodes = _this.manager.getOrderedRefs();
	      ...
	      defineProperty(assertThisInitialized(_this), "keyDrop", function (event) {
	      ...
	      defineProperty(assertThisInitialized(_this), "handleKeyEnd", function (event) {
	        if (_this.manager.active) {
	          _this.keyDrop(event);
	        }
	      });

	      defineProperty(assertThisInitialized(_this), "isValidSortingTarget", function (event) {
	        var useDragHandle = _this.props.useDragHandle;
	        var target = event.target;
	        var node = closest(target, function (el) {
	          return el.sortableInfo != null;
